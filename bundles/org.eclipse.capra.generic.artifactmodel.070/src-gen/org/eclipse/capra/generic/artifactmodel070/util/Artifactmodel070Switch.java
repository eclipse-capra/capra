 ...
 * @generated
 */
public class Artifactmodel070Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Artifactmodel070Package.ARTIFACT_WRAPPER_CONTAINER: {
			...
			case Artifactmodel070Package.ARTIFACT_WRAPPER: {
