...
import org.eclipse.capra.generic.artifactmodel070.ArtifactWrapperContainer;
import org.eclipse.capra.generic.artifactmodel070.Artifactmodel070Factory;
 ...
 * @generated
 */
public class Artifactmodel070PackageImpl extends EPackageImpl implements Artifactmodel070Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.capra.generic.artifactmodel070.Artifactmodel070Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Artifactmodel070PackageImpl() {
		super(eNS_URI, Artifactmodel070Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Artifactmodel070Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Artifactmodel070Package init() {
		if (isInited) return (Artifactmodel070Package)EPackage.Registry.INSTANCE.getEPackage(Artifactmodel070Package.eNS_URI);

		// Obtain or create and register package
		Object registeredArtifactmodel070Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Artifactmodel070PackageImpl theArtifactmodel070Package = registeredArtifactmodel070Package instanceof Artifactmodel070PackageImpl ? (Artifactmodel070PackageImpl)registeredArtifactmodel070Package : new Artifactmodel070PackageImpl();
		...
		theArtifactmodel070Package.createPackageContents();

		// Initialize created meta-data
		theArtifactmodel070Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theArtifactmodel070Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Artifactmodel070Package.eNS_URI, theArtifactmodel070Package);
		return theArtifactmodel070Package;
	}
	 ...
	 * @generated
	 */
	public Artifactmodel070Factory getArtifactmodel070Factory() {
		return (Artifactmodel070Factory)getEFactoryInstance();
	}
