...
import org.eclipse.capra.generic.tracemodel070.GenericTraceModel;
import org.eclipse.capra.generic.tracemodel070.RelatedTo;
import org.eclipse.capra.generic.tracemodel070.Tracemodel070Factory;
import org.eclipse.capra.generic.tracemodel070.Tracemodel070Package;
 ...
 * @generated
 */
public class Tracemodel070PackageImpl extends EPackageImpl implements Tracemodel070Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.capra.generic.tracemodel070.Tracemodel070Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Tracemodel070PackageImpl() {
		super(eNS_URI, Tracemodel070Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Tracemodel070Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Tracemodel070Package init() {
		if (isInited) return (Tracemodel070Package)EPackage.Registry.INSTANCE.getEPackage(Tracemodel070Package.eNS_URI);

		// Obtain or create and register package
		Object registeredTracemodel070Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Tracemodel070PackageImpl theTracemodel070Package = registeredTracemodel070Package instanceof Tracemodel070PackageImpl ? (Tracemodel070PackageImpl)registeredTracemodel070Package : new Tracemodel070PackageImpl();
		...
		theTracemodel070Package.createPackageContents();

		// Initialize created meta-data
		theTracemodel070Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTracemodel070Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Tracemodel070Package.eNS_URI, theTracemodel070Package);
		return theTracemodel070Package;
	}
	 ...
	 * @generated
	 */
	public Tracemodel070Factory getTracemodel070Factory() {
		return (Tracemodel070Factory)getEFactoryInstance();
	}
