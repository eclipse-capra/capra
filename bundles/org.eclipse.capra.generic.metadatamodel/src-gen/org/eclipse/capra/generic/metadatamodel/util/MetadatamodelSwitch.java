...
public class MetadatamodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MetadatamodelPackage.METADATA_CONTAINER: {
				MetadataContainer metadataContainer = (MetadataContainer)theEObject;
				T result = caseMetadataContainer(metadataContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetadatamodelPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetadatamodelPackage.TRACE_METADATA: {
				TraceMetadata traceMetadata = (TraceMetadata)theEObject;
				T result = caseTraceMetadata(traceMetadata);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetadatamodelPackage.ARTIFACT_METADATA: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Metadata Container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Metadata Container</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Trace Metadata</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Trace Metadata</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTraceMetadata(TraceMetadata object) {
		return null;
	}
