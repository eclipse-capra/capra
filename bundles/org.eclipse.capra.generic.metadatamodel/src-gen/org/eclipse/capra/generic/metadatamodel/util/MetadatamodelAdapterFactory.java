...
public class MetadatamodelAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected MetadatamodelSwitch<Adapter> modelSwitch =
		new MetadatamodelSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseTraceMetadata(TraceMetadata object) {
				return createTraceMetadataAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.capra.generic.metadatamodel.MetadataContainer <em>Metadata Container</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.capra.generic.metadatamodel.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.capra.generic.metadatamodel.TraceMetadata <em>Trace Metadata</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.capra.generic.metadatamodel.ArtifactMetadata <em>Artifact Metadata</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
