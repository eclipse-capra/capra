...
public interface TraceMetaModelAdapter {
	 ...
	 *                          the trace model.
	 * @param traceModel        Trace model to base calculation on
	 * @param relationshipTypes Relationship types to include. All relationship
	 ...
	 *         formulated.
	 */
	List<Connection> getInternalElements(EObject element, EObject traceModel, List<String> relationshipTypes);
	 ...
	 */
	List<Connection> getInternalElementsTransitive(EObject element, EObject traceModel, List<String> relationshipTypes,
